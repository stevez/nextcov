...
- **Worker pool unit tests** - Added comprehensive tests for single-threaded and multi-threaded modes
  - Tests for `NEXTCOV_WORKERS` environment variable handling
  - Tests for singleton pool behavior
  - Tests for graceful error handling in single-threaded mode
